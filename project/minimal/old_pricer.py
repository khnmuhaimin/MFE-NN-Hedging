...
def plot_learning_curve(epoch_losses: list) -> None:
    ...
    plt.tight_layout()
    plt.savefig(project_path("results/figures/learning_curve.png"), dpi=150, bbox_inches="tight")
    plt.close()
...
def plot_delta_paths(S_test: np.ndarray, hedging_net: HedgingNet) -> None:
    ...
    plt.tight_layout()
    plt.savefig(project_path("results/figures/delta_paths.png"), dpi=150, bbox_inches="tight")
    plt.close()
